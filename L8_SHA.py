...
rotr = lambda x,n: ((x>>n) | (x<<64-n)) & 0xffffffffffffffff
...
def sha512(msg):
    ...
    W = [0] * 80
    for i in range(16):
        W[i] = struct.unpack(">Q", padded[i*8:i*8+8])[0]
    ...
    for i in range(80):
        ...
        ch = (e & f) ^ (~e & g)
        t1 = (h + ch + S1 + K[i] + W[i]) & 0xffffffffffffffff
...
#     print("a=%08x b=%08x c=%08x d=%08x e=%08x f=%08x g=%08x h=%08x\n" % tuple(H))
...
#     for i in range(16):
#         W[i] = struct.unpack(">I", padded[i*4:i*4+4])[0]
